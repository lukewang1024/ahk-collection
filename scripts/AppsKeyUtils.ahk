...
; Media controls
#If Getkeystate("AppsKey","p") ;if AppsKey is held the following hotkey is active.
F5::Send {Media_Stop}
return
F6::Send {Media_Prev}
return
...
return
F12::MsgBox, 0, Quick sleep, RAlt + AppsKey + F12 to put PC into sleep`nRCtrl + RAlt + AppsKey + F12 to put PC into hibernate, 2
return
>!F12::
  DllCall("PowrProf\SetSuspendState", "int", 0, "int", 0, "int", 0)
return
